...
if(dir_path is True):
    ...
    t.saveModel(wHidden2, "model/wHidden2")
    t.saveModel(wHidden1, "model/wHidden1")
    t.saveModel(wInput, "model/wInput")
    t.saveModel(biasO, "model/biasO")
    t.saveModel(biasHidden2, "model/biasHidden2")
    t.saveModel(biasHidden1, "model/biasHidden1")